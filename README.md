...
*LogsApi* | [**listLogs**](docs/Api/LogsApi.md#listlogs) | **GET** /{ledger}/log | List the logs from a ledger.
...
- [ListLogs200ResponseCursor](docs/Model/ListLogs200ResponseCursor.md)
- [ListLogs200ResponseCursorAllOf](docs/Model/ListLogs200ResponseCursorAllOf.md)
