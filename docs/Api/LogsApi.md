...
```php
listLogs($ledger, $page_size, $after, $start_time, $end_time, $pagination_token): \Numary\Ledger\Model\ListLogs200Response
```
...
[**\Numary\Ledger\Model\ListLogs200Response**](../Model/ListLogs200Response.md)
