...
class LogsApi
{
     ...
     */
    public function listLogs($ledger, $page_size = 15, $page_size2 = 15, $after = null, $start_time = null, $start_time2 = null, $end_time = null, $end_time2 = null, $cursor = null, $pagination_token = null)
    {
        list($response) = $this->listLogsWithHttpInfo($ledger, $page_size, $page_size2, $after, $start_time, $start_time2, $end_time, $end_time2, $cursor, $pagination_token);
        return $response;
    }
     ...
     */
    public function listLogsWithHttpInfo($ledger, $page_size = 15, $page_size2 = 15, $after = null, $start_time = null, $start_time2 = null, $end_time = null, $end_time2 = null, $cursor = null, $pagination_token = null)
    {
        $request = $this->listLogsRequest($ledger, $page_size, $page_size2, $after, $start_time, $start_time2, $end_time, $end_time2, $cursor, $pagination_token);
     ...
     */
    public function listLogsAsync($ledger, $page_size = 15, $page_size2 = 15, $after = null, $start_time = null, $start_time2 = null, $end_time = null, $end_time2 = null, $cursor = null, $pagination_token = null)
    {
        return $this->listLogsAsyncWithHttpInfo($ledger, $page_size, $page_size2, $after, $start_time, $start_time2, $end_time, $end_time2, $cursor, $pagination_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listLogsAsyncWithHttpInfo($ledger, $page_size = 15, $page_size2 = 15, $after = null, $start_time = null, $start_time2 = null, $end_time = null, $end_time2 = null, $cursor = null, $pagination_token = null)
    {
        $returnType = '\Numary\Ledger\Model\LogsCursorResponse';
        $request = $this->listLogsRequest($ledger, $page_size, $page_size2, $after, $start_time, $start_time2, $end_time, $end_time2, $cursor, $pagination_token);
     ...
     */
    public function listLogsRequest($ledger, $page_size = 15, $page_size2 = 15, $after = null, $start_time = null, $start_time2 = null, $end_time = null, $end_time2 = null, $cursor = null, $pagination_token = null)
    {
