...
/**
     ...
     * @return \Numary\Ledger\Model\ScriptResult|\Numary\Ledger\Model\RunScript400Response|\Numary\Ledger\Model\AddMetadataToAccount409Response
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\ScriptResult|\Numary\Ledger\Model\RunScript400Response|\Numary\Ledger\Model\AddMetadataToAccount409Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function runScriptWithHttpInfo($ledger, $script, $preview = null, string $contentType = self::contentTypes['runScript'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\Numary\Ledger\Model\RunScript400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Numary\Ledger\Model\RunScript400Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Numary\Ledger\Model\RunScript400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 409:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Numary\Ledger\Model\RunScript400Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
