...
class TransactionsApi
{
     ...
     * @param  string $account Filter transactions with postings involving given account, either as source or destination. (optional)
     * @param  string $source Filter transactions with postings involving given account at source. (optional)
     * @param  string $destination Filter transactions with postings involving given account at destination. (optional)
     *
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function countTransactions($ledger, $reference = null, $account = null, $source = null, $destination = null)
    {
        $this->countTransactionsWithHttpInfo($ledger, $reference, $account, $source, $destination);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function countTransactionsWithHttpInfo($ledger, $reference = null, $account = null, $source = null, $destination = null)
    {
        $request = $this->countTransactionsRequest($ledger, $reference, $account, $source, $destination);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function countTransactionsAsync($ledger, $reference = null, $account = null, $source = null, $destination = null)
    {
        return $this->countTransactionsAsyncWithHttpInfo($ledger, $reference, $account, $source, $destination)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function countTransactionsAsyncWithHttpInfo($ledger, $reference = null, $account = null, $source = null, $destination = null)
    {
        $returnType = '';
        $request = $this->countTransactionsRequest($ledger, $reference, $account, $source, $destination);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function countTransactionsRequest($ledger, $reference = null, $account = null, $source = null, $destination = null)
    {
        // verify the required parameter 'ledger' is set
        if ($ledger === null || (is_array($ledger) && count($ledger) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\CreateTransactionResponse|\Numary\Ledger\Model\CreateTransactionResponse|\Numary\Ledger\Model\ErrorResponse|\Numary\Ledger\Model\ErrorResponse
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\CreateTransactionResponse|\Numary\Ledger\Model\CreateTransactionResponse|\Numary\Ledger\Model\ErrorResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\CreateTransactions200Response|\Numary\Ledger\Model\ErrorResponse|\Numary\Ledger\Model\ErrorResponse
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\CreateTransactions200Response|\Numary\Ledger\Model\ErrorResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTransactionsWithHttpInfo($ledger, $transactions)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Numary\Ledger\Model\CreateTransactions200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Numary\Ledger\Model\CreateTransactions200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Numary\Ledger\Model\CreateTransactions200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Numary\Ledger\Model\CreateTransactions200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\ListTransactions200Response
     */
    public function listTransactions($ledger, $after = null, $reference = null, $account = null, $source = null, $destination = null, $start_time = null, $end_time = null)
    {
        list($response) = $this->listTransactionsWithHttpInfo($ledger, $after, $reference, $account, $source, $destination, $start_time, $end_time);
        return $response;
    }
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\ListTransactions200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function listTransactionsWithHttpInfo($ledger, $after = null, $reference = null, $account = null, $source = null, $destination = null, $start_time = null, $end_time = null)
    {
        $request = $this->listTransactionsRequest($ledger, $after, $reference, $account, $source, $destination, $start_time, $end_time);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listTransactionsAsync($ledger, $after = null, $reference = null, $account = null, $source = null, $destination = null, $start_time = null, $end_time = null)
    {
        return $this->listTransactionsAsyncWithHttpInfo($ledger, $after, $reference, $account, $source, $destination, $start_time, $end_time)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listTransactionsAsyncWithHttpInfo($ledger, $after = null, $reference = null, $account = null, $source = null, $destination = null, $start_time = null, $end_time = null)
    {
        $returnType = '\Numary\Ledger\Model\ListTransactions200Response';
        $request = $this->listTransactionsRequest($ledger, $after, $reference, $account, $source, $destination, $start_time, $end_time);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listTransactionsRequest($ledger, $after = null, $reference = null, $account = null, $source = null, $destination = null, $start_time = null, $end_time = null)
    {
        // verify the required parameter 'ledger' is set
        if ($ledger === null || (is_array($ledger) && count($ledger) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\TransactionResponse
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\TransactionResponse, HTTP status code, HTTP response headers (array of strings)
     */
