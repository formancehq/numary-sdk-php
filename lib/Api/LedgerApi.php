 ...
 *
 * The version of the OpenAPI document: v1.10.15
...
/**
    ...
    public function addMetadataOnTransactionRequest($ledger, $txid, $request_body = null, string $contentType = self::contentTypes['addMetadataOnTransaction'][0])
    {
        ...
        if ($txid < 0) {
            throw new \InvalidArgumentException('invalid value for "$txid" when calling LedgerApi.addMetadataOnTransaction, must be bigger than or equal to 0.');
        }
     ...
     *
     * @param  string $ledger Name of the ledger. (required)
     * @param  \Numary\Ledger\Model\PostTransaction $post_transaction The request body must contain at least one of the following objects:   - &#x60;postings&#x60;: suitable for simple transactions   - &#x60;script&#x60;: enabling more complex transactions with Numscript (required)
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\TransactionsResponse|\Numary\Ledger\Model\ErrorResponse
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\TransactionsResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\AccountResponse|\Numary\Ledger\Model\ErrorResponse
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\AccountResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    if ('\Numary\Ledger\Model\AccountResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Numary\Ledger\Model\AccountResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\BalancesCursorResponse|\Numary\Ledger\Model\ErrorResponse
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\BalancesCursorResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBalancesWithHttpInfo($ledger, $address = null, $after = null, $cursor = null, $pagination_token = null, string $contentType = self::contentTypes['getBalances'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Numary\Ledger\Model\BalancesCursorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Numary\Ledger\Model\BalancesCursorResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Numary\Ledger\Model\BalancesCursorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Numary\Ledger\Model\BalancesCursorResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Numary\Ledger\Model\BalancesCursorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\AggregateBalancesResponse|\Numary\Ledger\Model\ErrorResponse
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\AggregateBalancesResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBalancesAggregatedWithHttpInfo($ledger, $address = null, string $contentType = self::contentTypes['getBalancesAggregated'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Numary\Ledger\Model\AggregateBalancesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Numary\Ledger\Model\AggregateBalancesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Numary\Ledger\Model\AggregateBalancesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Numary\Ledger\Model\AggregateBalancesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Numary\Ledger\Model\AggregateBalancesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\ConfigInfoResponse|\Numary\Ledger\Model\ErrorResponse
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\ConfigInfoResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInfoWithHttpInfo(string $contentType = self::contentTypes['getInfo'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Numary\Ledger\Model\ConfigInfoResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Numary\Ledger\Model\ConfigInfoResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Numary\Ledger\Model\ConfigInfoResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Numary\Ledger\Model\ConfigInfoResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Numary\Ledger\Model\ConfigInfoResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getTransactionRequest($ledger, $txid, string $contentType = self::contentTypes['getTransaction'][0])
    {
        ...
        if ($txid < 0) {
            throw new \InvalidArgumentException('invalid value for "$txid" when calling LedgerApi.getTransaction, must be bigger than or equal to 0.');
        }
     ...
     * @param  string $balance_asset Filter accounts by their balance asset (optional)
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\AccountsCursorResponse|\Numary\Ledger\Model\ErrorResponse
     */
    public function listAccounts($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_asset = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null, string $contentType = self::contentTypes['listAccounts'][0])
    {
        list($response) = $this->listAccountsWithHttpInfo($ledger, $page_size, $page_size2, $after, $address, $metadata, $balance, $balance_asset, $balance_operator, $balance_operator2, $cursor, $pagination_token, $contentType);
        return $response;
    }
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\AccountsCursorResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listAccountsWithHttpInfo($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_asset = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null, string $contentType = self::contentTypes['listAccounts'][0])
    {
        $request = $this->listAccountsRequest($ledger, $page_size, $page_size2, $after, $address, $metadata, $balance, $balance_asset, $balance_operator, $balance_operator2, $cursor, $pagination_token, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Numary\Ledger\Model\AccountsCursorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Numary\Ledger\Model\AccountsCursorResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Numary\Ledger\Model\AccountsCursorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Numary\Ledger\Model\AccountsCursorResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Numary\Ledger\Model\AccountsCursorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAccountsAsync($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_asset = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null, string $contentType = self::contentTypes['listAccounts'][0])
    {
        return $this->listAccountsAsyncWithHttpInfo($ledger, $page_size, $page_size2, $after, $address, $metadata, $balance, $balance_asset, $balance_operator, $balance_operator2, $cursor, $pagination_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAccountsAsyncWithHttpInfo($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_asset = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null, string $contentType = self::contentTypes['listAccounts'][0])
    {
        $returnType = '\Numary\Ledger\Model\AccountsCursorResponse';
        $request = $this->listAccountsRequest($ledger, $page_size, $page_size2, $after, $address, $metadata, $balance, $balance_asset, $balance_operator, $balance_operator2, $cursor, $pagination_token, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listAccountsRequest($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_asset = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null, string $contentType = self::contentTypes['listAccounts'][0])
    {
        ...
        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LedgerApi.listAccounts, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LedgerApi.listAccounts, must be bigger than or equal to 1.');
        }
        
        if ($page_size2 !== null && $page_size2 > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size2" when calling LedgerApi.listAccounts, must be smaller than or equal to 1000.');
        }
        if ($page_size2 !== null && $page_size2 < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size2" when calling LedgerApi.listAccounts, must be bigger than or equal to 1.');
        }
    ...
    public function listLogsRequest($ledger, $page_size = 15, $page_size2 = 15, $after = null, $start_time = null, $start_time2 = null, $end_time = null, $end_time2 = null, $cursor = null, $pagination_token = null, string $contentType = self::contentTypes['listLogs'][0])
    {
        ...
        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LedgerApi.listLogs, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LedgerApi.listLogs, must be bigger than or equal to 1.');
        }
        
        if ($page_size2 !== null && $page_size2 > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size2" when calling LedgerApi.listLogs, must be smaller than or equal to 1000.');
        }
        if ($page_size2 !== null && $page_size2 < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size2" when calling LedgerApi.listLogs, must be bigger than or equal to 1.');
        }
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Numary\Ledger\Model\TransactionsCursorResponse|\Numary\Ledger\Model\ErrorResponse
     */
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\TransactionsCursorResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listTransactionsWithHttpInfo($ledger, $page_size = 15, $page_size2 = 15, $after = null, $reference = null, $account = null, $source = null, $destination = null, $start_time = null, $start_time2 = null, $end_time = null, $end_time2 = null, $cursor = null, $pagination_token = null, $metadata = null, string $contentType = self::contentTypes['listTransactions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Numary\Ledger\Model\TransactionsCursorResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Numary\Ledger\Model\TransactionsCursorResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Numary\Ledger\Model\TransactionsCursorResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Numary\Ledger\Model\TransactionsCursorResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Numary\Ledger\Model\TransactionsCursorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function listTransactionsRequest($ledger, $page_size = 15, $page_size2 = 15, $after = null, $reference = null, $account = null, $source = null, $destination = null, $start_time = null, $start_time2 = null, $end_time = null, $end_time2 = null, $cursor = null, $pagination_token = null, $metadata = null, string $contentType = self::contentTypes['listTransactions'][0])
    {
        ...
        if ($page_size !== null && $page_size > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LedgerApi.listTransactions, must be smaller than or equal to 1000.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling LedgerApi.listTransactions, must be bigger than or equal to 1.');
        }
        
        if ($page_size2 !== null && $page_size2 > 1000) {
            throw new \InvalidArgumentException('invalid value for "$page_size2" when calling LedgerApi.listTransactions, must be smaller than or equal to 1000.');
        }
        if ($page_size2 !== null && $page_size2 < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size2" when calling LedgerApi.listTransactions, must be bigger than or equal to 1.');
        }
     ...
     * @param  string $ledger Name of the ledger. (required)
     * @param  int $txid Transaction ID. (required)
     * @param  bool $disable_checks Allow to disable balances checks (optional)
     ...
     * @return \Numary\Ledger\Model\TransactionResponse|\Numary\Ledger\Model\ErrorResponse
     */
    public function revertTransaction($ledger, $txid, $disable_checks = null, string $contentType = self::contentTypes['revertTransaction'][0])
    {
        list($response) = $this->revertTransactionWithHttpInfo($ledger, $txid, $disable_checks, $contentType);
        return $response;
    }
     ...
     * @return array of \Numary\Ledger\Model\TransactionResponse|\Numary\Ledger\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function revertTransactionWithHttpInfo($ledger, $txid, $disable_checks = null, string $contentType = self::contentTypes['revertTransaction'][0])
    {
        $request = $this->revertTransactionRequest($ledger, $txid, $disable_checks, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revertTransactionAsync($ledger, $txid, $disable_checks = null, string $contentType = self::contentTypes['revertTransaction'][0])
    {
        return $this->revertTransactionAsyncWithHttpInfo($ledger, $txid, $disable_checks, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revertTransactionAsyncWithHttpInfo($ledger, $txid, $disable_checks = null, string $contentType = self::contentTypes['revertTransaction'][0])
    {
        $returnType = '\Numary\Ledger\Model\TransactionResponse';
        $request = $this->revertTransactionRequest($ledger, $txid, $disable_checks, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function revertTransactionRequest($ledger, $txid, $disable_checks = null, string $contentType = self::contentTypes['revertTransaction'][0])
    {
        ...
        if ($txid < 0) {
            throw new \InvalidArgumentException('invalid value for "$txid" when calling LedgerApi.revertTransaction, must be bigger than or equal to 0.');
        }
