...
class LedgerApi
{
     ...
     */
    public function getLedgerInfo($ledger)
    {
        list($response) = $this->getLedgerInfoWithHttpInfo($ledger);
        return $response;
    }
     ...
     */
    public function getLedgerInfoWithHttpInfo($ledger)
    {
        $request = $this->getLedgerInfoRequest($ledger);
     ...
     */
    public function getLedgerInfoAsync($ledger)
    {
        return $this->getLedgerInfoAsyncWithHttpInfo($ledger)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLedgerInfoAsyncWithHttpInfo($ledger)
    {
        $returnType = '\Numary\Ledger\Model\LedgerInfoResponse';
        $request = $this->getLedgerInfoRequest($ledger);
     ...
     */
    public function getLedgerInfoRequest($ledger)
    {
