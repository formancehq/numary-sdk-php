...
class StatsApi
{
     ...
     * @return \Numary\Ledger\Model\StatsResponse
     */
    public function readStats($ledger)
    {
        list($response) = $this->readStatsWithHttpInfo($ledger);
        return $response;
    }
     ...
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Numary\Ledger\Model\StatsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function readStatsWithHttpInfo($ledger)
    {
        $request = $this->readStatsRequest($ledger);
     ...
     */
    public function readStatsAsync($ledger)
    {
        return $this->readStatsAsyncWithHttpInfo($ledger)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function readStatsAsyncWithHttpInfo($ledger)
    {
        $returnType = '\Numary\Ledger\Model\StatsResponse';
        $request = $this->readStatsRequest($ledger);
     ...
     */
    public function readStatsRequest($ledger)
    {
