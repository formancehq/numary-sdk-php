...
class AccountsApi
{
     ...
     */
    public function listAccounts($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null)
    {
        list($response) = $this->listAccountsWithHttpInfo($ledger, $page_size, $page_size2, $after, $address, $metadata, $balance, $balance_operator, $balance_operator2, $cursor, $pagination_token);
        return $response;
    }
     ...
     */
    public function listAccountsWithHttpInfo($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null)
    {
        $request = $this->listAccountsRequest($ledger, $page_size, $page_size2, $after, $address, $metadata, $balance, $balance_operator, $balance_operator2, $cursor, $pagination_token);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAccountsAsync($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null)
    {
        return $this->listAccountsAsyncWithHttpInfo($ledger, $page_size, $page_size2, $after, $address, $metadata, $balance, $balance_operator, $balance_operator2, $cursor, $pagination_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAccountsAsyncWithHttpInfo($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null)
    {
        $returnType = '\Numary\Ledger\Model\AccountsCursorResponse';
        $request = $this->listAccountsRequest($ledger, $page_size, $page_size2, $after, $address, $metadata, $balance, $balance_operator, $balance_operator2, $cursor, $pagination_token);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listAccountsRequest($ledger, $page_size = 15, $page_size2 = 15, $after = null, $address = null, $metadata = null, $balance = null, $balance_operator = null, $balance_operator2 = null, $cursor = null, $pagination_token = null)
    {
