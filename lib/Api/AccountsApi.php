...
class AccountsApi
{
     ...
     * @param  string $address account address (optional)
     * @param  array<string,string> $metadata metadata (optional)
     *
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function countAccounts($ledger, $after = null, $address = null, $metadata = null)
    {
        $this->countAccountsWithHttpInfo($ledger, $after, $address, $metadata);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function countAccountsWithHttpInfo($ledger, $after = null, $address = null, $metadata = null)
    {
        $request = $this->countAccountsRequest($ledger, $after, $address, $metadata);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function countAccountsAsync($ledger, $after = null, $address = null, $metadata = null)
    {
        return $this->countAccountsAsyncWithHttpInfo($ledger, $after, $address, $metadata)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function countAccountsAsyncWithHttpInfo($ledger, $after = null, $address = null, $metadata = null)
    {
        $returnType = '';
        $request = $this->countAccountsRequest($ledger, $after, $address, $metadata);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function countAccountsRequest($ledger, $after = null, $address = null, $metadata = null)
    {
        // verify the required parameter 'ledger' is set
        if ($ledger === null || (is_array($ledger) && count($ledger) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (is_array($metadata)) {
            $metadata = ObjectSerializer::serializeCollection($metadata, 'deepObject', true);
        }
        if ($metadata !== null) {
     ...
     * @param  string $after pagination cursor, will return accounts after given address (in descending order) (optional)
     * @param  string $address account address (optional)
     * @param  array<string,string> $metadata account address (optional)
     *
     * @throws \Numary\Ledger\ApiException on non-2xx response
     * @throws \InvalidArgumentException
