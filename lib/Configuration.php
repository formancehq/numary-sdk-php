...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://.o.numary.cloud/ledger';
    ...
    {
        $report  = 'PHP SDK (Numary\Ledger) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1.8.0-beta.3' . PHP_EOL;
