...
/**
 * GetBalances200ResponseCursor Class Doc Comment
 *
 * @category Class
 * @package  Numary\Ledger
 * @author   OpenAPI Generator team
 ...
 */
class GetBalances200ResponseCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getBalances_200_response_cursor';
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (($page_size > 1000)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling GetBalances200ResponseCursor., must be smaller than or equal to 1000.');
        }
        if (($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling GetBalances200ResponseCursor., must be bigger than or equal to 1.');
        }
