...
class ListTransactions200ResponseCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (($page_size > 1000)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ListTransactions200ResponseCursor., must be smaller than or equal to 1000.');
        }
        if (($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ListTransactions200ResponseCursor., must be bigger than or equal to 1.');
        }
