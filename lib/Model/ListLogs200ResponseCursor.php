...
/**
 * ListLogs200ResponseCursor Class Doc Comment
 *
 * @category Class
 * @package  Numary\Ledger
 * @author   OpenAPI Generator team
 ...
 */
class ListLogs200ResponseCursor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listLogs_200_response_cursor';
    ...
    */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (($page_size > 1000)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ListLogs200ResponseCursor., must be smaller than or equal to 1000.');
        }
        if (($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ListLogs200ResponseCursor., must be bigger than or equal to 1.');
        }
     ...
     * Gets data
     *
     * @return \Numary\Ledger\Model\Log[]
     */
     ...
     * Sets data
     *
     * @param \Numary\Ledger\Model\Log[] $data data
     *
     * @return self
     */
